...
rawImpFromDecl decl = case decl of
    ...
    IRecord fc1 y z _ (MkWithData _ (MkImpRecord header _ body)) => do
        binder <- header.val
        field <- body.val
...
findBindableNamesQuot env used (ITypeLevel fc _) = []
...
mutual
  ...
  substNames' bvar bound ps (IAs fc nameFC s y pat)
      = IAs fc nameFC s y (substNames' bvar bound ps pat)
  substNames' bvar bound ps (IMustUnify fc r pat)
      = IMustUnify fc r (substNames' bvar bound ps pat)
...
mutual
  ...
  substLoc fc' (IAs fc nameFC s y pat)
      = IAs fc' fc' s y (substLoc fc' pat)
  substLoc fc' (IMustUnify fc r pat)
      = IMustUnify fc' r (substLoc fc' pat)
