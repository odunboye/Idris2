...
knownTopics = [
    ...
    ("declare.record.projection.qualified", Just "Showing the qualified projection alias (RecordName.field)"),
    ...
    ("desugar.open", Just "Log desugaring of 'let open' expressions"),
    ("doc.data", Nothing),
