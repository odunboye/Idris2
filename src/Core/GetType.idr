...
mutual
  ...
  chk env (TFix fc _ _) = pure (gErased fc)
  chk env (TLater fc _ _) = pure (gErased fc)
  chk env (TNext fc _ _) = pure (gErased fc)
  chk env (TTickAbs fc _ _) = pure (gErased fc)
  chk env (TTickApp fc _ _) = pure (gErased fc)
